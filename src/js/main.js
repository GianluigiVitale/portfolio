document.addEventListener('DOMContentLoaded', function () {
    ...
    var italian = {
        ...
        nowPublicationKey: 'Pubblicazione più recente', nowPublicationValue: 'STF · poster NeurIPS 2026',
        nowMlsysKey: 'MLSys 2026', nowMlsysValue: 'DriftBench · orale · unico autore',
        nowServiceKey: 'Servizio', nowServiceValue: 'Program Committee MLSys 2027 · Ethics NeurIPS · Artifact Evaluation MLSys e SOSP',
        oralPresentation: 'Presentazione orale', soleAuthor: 'Unico autore', acmBadges: 'Badge ACM: Available · Functional · Reproduced',
        recordedTalk: 'Guarda il talk MLSys 2026',
        ...
        neuripsStatus: 'Poster accettato · Unico autore',
        neuripsSummary: 'Un’ablatione fattoriale 2×2×2 pre-specificata della pipeline di professional framing STF, valutata in circa 31.900 prove su nove LLM. L’adozione della persona è risultata il principale fattore dell’accettazione (OR = 6,5), la sostituzione terminologica il principale fattore della profondità della risposta (β = 0,91), mentre la giustificazione morale non ha mostrato alcun effetto positivo rilevabile entro i limiti di equivalenza dichiarati.',
        neuripsPaperLink: 'Paper su OpenReview',
        ...
        mlsysPcDesc: 'Revisione delle submission per il programma tecnico di MLSys 2027.',
        ...
        sospTitle: 'Membro dell’Artifact Evaluation Committee — SOSP 2026',
        sospDesc: 'Valutazione di artefatti di ricerca sul serving di modelli efficiente in memoria e sull’analisi della sicurezza della memoria per kernel GPU usati nei sistemi di inferenza LLM. Verifica di disponibilità, funzionalità, riproducibilità e coerenza con le affermazioni sperimentali dei paper associati.',
        mlsysAeTitle: 'Membro dell’Artifact Evaluation Committee — MLSys 2026',
        mlsysAeDesc: 'Valutazione di quattro submission accettate su ottimizzazione dei kernel di attenzione, infrastrutture di profiling ML, disaggregazione della memoria GPU e inferenza distribuita. Riproduzione dei risultati sperimentali su cluster 8×H100 a noleggio (RunPod) e infrastruttura AMD MI350X (AMD University Program), verificando disponibilità, funzionalità e coerenza con le affermazioni di ciascun paper.',
        ...
        ministryTitle: 'Systems Engineer — Archivio di Stato di Pistoia, Ministero della Cultura',
        ministryDesc: 'Progettazione e deployment di un sistema di retrieval-augmented generation su oltre 10.000 documenti amministrativi interni, con risposte corredate da fonti per le richieste del personale. Realizzazione di un’interfaccia di consultazione pubblica assistita dall’AI che offre a personale e cittadini accesso in linguaggio naturale all’intero database inventariale.',
