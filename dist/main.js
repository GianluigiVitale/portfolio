...
$(document).ready(function () {
  ...
  var templateProject = Handlebars.compile(sourceProjects); // end templates
  ...
  ScrollReveal().reveal('#currentYear', {
    delay: 500
  }); // set the current year

  $('#currentYear').text(setCurrentYear()); // handlebars statements

  handelbarsStatements();
  animationsStatements(); // delay handlebars skills and projects
  ...
  function textTerminal(variable, name) {
    // given a div and a text populates the div with the text imitating a user writing in a terminal
    var i = 0;
  ...
  function handelbarsStatements() {
    ...
    $('.statement-added').empty(); // array of statements
  ...
  function handelbarsProjects() {
    ...
    $('.project-container').empty(); // array of projects
  ...
  function slowScroll(value) {
    // scrolls to the given div slowly
  ...
  function traduzioneItaliano() {
    // translates the website in italian
  ...
  function traduzioneInglese() {
    // translates the website in english
